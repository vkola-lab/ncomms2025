...
model_preds = pd.read_csv('./source_data/stage_1_model_predictions.csv')
...
generate_roc(y_true_, scores_proba_, labels, figname=f'./pdf_plots/fig2a')
generate_pr(y_true_, scores_proba_, labels, figname=f'./pdf_plots/fig2b')
