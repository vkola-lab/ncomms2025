...
ab_tau_labels = ['amy_label', 'tau_label']
tau_reg_labels = ['tau_front_label', 'tau_occ_label', 'tau_medtemp_label', 'tau_lattemp_label', 'tau_medpar_label', 'tau_latpar_label']
...
class ADRDModel(BaseEstimator):
    ...
    # def fit(self, x, y) -> Self:
        ...
        self._init_net()
        # print(self.net_.modules_emb_src.WB_T1_EMBED)
        # raise ValueError
